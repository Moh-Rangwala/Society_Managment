...
const Manager = ({}) => {
  ...
  const [title, setTitle] = useState("MANAGER DASHBOARD");
  ...
  const [userManagerData, setUserManagerData] = useState(null);
  const dispatch = useDispatch();

  useEffect(() => {
    const userData = sessionStorage.getItem("managerUser");
    if (userData) {
      setUserManagerData(JSON.parse(userData));
      axios({
        baseURL: BASE_URL,
        method: "get",
      ...
      <strong>
        <Button
          ...
          onClick={() => {
            ...
            history.push("/manager/crud-edit-page", {
              data: params.row,
              role: 'manager'
            });
          }}
    ...
    return (
      <strong>
        <Button
          ...
          onClick={() => {
            // console.log(params.row);
            history.push("/manager/chat-user",  {
              data: params.row,
              role: 'manager'
            });
          }}
          ...
          <ProSidebar style={{ width: "100%", height: "100%" }}>
            <Menu iconShape="square">
              ...
              <SubMenu title="Residents and Visitors">
                <MenuItem
                  onClick={() => {
                    setColumnData(columns.resident(renderEditButton, renderChatButton));
                    setContent("resident");
                ...
                <MenuItem
                  onClick={() => {
                    setColumnData(columns.visitor(renderEditButton, renderChatButton));
                    setContent("visitor");
              ...
              <div className="tab-content-container">
                <div className="tab-content-container-header-and-add-button">
                  ...
                  {addButton ? (
                    <button
                      onClick={() => {
                        history.push("/manager/crud-add-page", {role: 'manager'});
                      }}
